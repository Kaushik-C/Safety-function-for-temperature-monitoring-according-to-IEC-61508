...
#ifndef STATISTICAL_CODECOV_TESTING_H_
#define STATISTICAL_CODECOV_TESTING_H_

extern unsigned int PerformStatisticalTest(void);
extern unsigned int PerformCodeCoverageTest(void);

#endif /* STATISTICAL_CODECOV_TESTING_H_ */
